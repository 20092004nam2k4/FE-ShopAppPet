...
const ProductList = () => {
    ...
    const getBreedFromTab = (tab) => {
        switch (tab) {
            ...
            case 'Chó Bảo Vệ':
                return 'Guard Dog'; // Replace with actual breed if needed
            case 'Chó Mặt Xệ':
                return 'Droopy Face Dog'; // Replace with actual breed if needed
            case 'Chó Ngao':
                return 'Mastiff'; // Replace with actual breed if needed
            case 'Chó Bull':
                return 'Bull Dog'; // Replace with actual breed if needed
            case 'Chó Săn':
                return 'Hunting Dog'; // Replace with actual breed if needed
            case 'Chó Kéo Xe':
                return 'Sled Dog'; // Replace with actual breed if needed
            case 'Chó Xoáy':
                return 'Spinning Dog'; // Replace with actual breed if needed
            case 'Mèo Quý Tộc':
                return 'Noble Cat'; // Replace with actual breed if needed
            case 'Đáng yêu':
                return 'Cute Cat'; // Replace with actual breed if needed
            case 'Lông dài':
                return 'Long Haired Cat'; // Replace with actual breed if needed
            case 'Lông ngắn':
                return 'Short Haired Cat'; // Replace with actual breed if needed
            case 'ít rụng lông':
                return 'Low Shedding Cat'; // Replace with actual breed if needed
            default:
