...
import './styles.css'; // Đảm bảo bạn đã nhập CSS vào project của bạn

const MyComponent = () => {
    return (
        <div>
            <a href="#" className="no-focus-outline">Link Text</a>
            <p className="no-focus-outline">Some text here</p>
        </div>
    );
};
