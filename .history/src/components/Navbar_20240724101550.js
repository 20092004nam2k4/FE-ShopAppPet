            ...
            {showIcons && (
                <div className="banner-icons">
                    <button className="icon-button">
                        <img src="https://azpet.com.vn/wp-content/themes/azpet/assets/img/header-free-ship.png" alt="Free Shipping" />
                    </button>
                    <button className="icon-button">
                        <img src="https://azpet.com.vn/wp-content/themes/azpet/assets/img/header-bh-365.png" alt="365 Days Warranty" />
                    </button>
