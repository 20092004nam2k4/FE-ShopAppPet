        ...
        <div className="container">
          <div className="row">
            <div className="col-md-3">
              <h5 className='thanh'>LIÊN HỆ AZPET</h5>
              <ul className="list-unstyled">
                <li><FaMapMarkerAlt /> Trụ Sở: 59 Văn Cao, Liễu Giai, Ba Đình, Hà Nội</li>
                <li><FaMapMarkerAlt /> Trại Giống: Quỳnh Hội, Quỳnh Phụ, Thái Bình</li>
                <li><FiPhone />  Hotline: 0888 08 3388</li>
                <li>
                 <a href="https://azpet.com.vn" className="text-white">Website:https://azpet.com.vn</a>
                </li>
            ...
            <div className="col-md-3">
              <h5 className='thanh'>VỀ AZPET</h5>
              <ul className="list-unstyled">
            ...
            <div className="col-md-3">
              <h5 className='thanh'>CHÍNH SÁCH MUA HÀNG</h5>
              <ul className="list-unstyled">
                <li>Mua Trả Góp</li>
            ...
            <div className="col-md-3 cart">
              <div className="col text-center">
                <h5 className='thanh'>KẾT NỐI, THANH TOÁN</h5>
