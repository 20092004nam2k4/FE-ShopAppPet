                    ...
                    <div className="parent-cat__main">
                        <div className="f aic jcc parent-cat__nav">
                            ...
                            <ol className="flickity-page-dots">
                                ...
                                <li className="dot" aria-label="Page dot 6"></li>
                                <li className="dot" aria-label="Page dot 7"></li>
                                <li className="dot" aria-label="Page dot 8"></li>
                                <li className="dot" aria-label="Page dot 9"></li>
                            </ol>
                        </div>
                    </div>
                </div>
