...
import { useHistory } from 'react-router-dom'; // Import useHistory để điều hướng
...
const ProductList = () => {
    ...
    const handleProductClick = (id) => {
        history.push(`/product/${id}`); // Điều hướng đến trang chi tiết sản phẩm khi nhấp vào sản phẩm
    };
                                    ...
                                    <div className="grid__col image-row__col default-section__col image-row__col image-row__col--100">
                                        ...
                                        >
                                            <picture className="image image--default image-row__image">
                                                ...
                                                />
                                                <source
                                                    srcSet="https://azpet.com.vn/wp-content/uploads/2021/07/hop-tac-nhan-giong-cho-canh.jpg"
                                                    sizes="780px"
                                                    media="(min-width: 481px)"
                                                />
                                                <img
                                                    src="https://azpet.com.vn/wp-content/uploads/2021/07/hop-tac-nhan-giong-cho-canh.jpg"
                                                    alt="Hợp tác nhân giống chó cảnh"
                                                />
                                            </picture>
                                        </a>
                                    </div>
