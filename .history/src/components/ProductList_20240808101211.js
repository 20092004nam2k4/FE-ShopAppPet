...
const ProductList = () => {
    ...
    const getBreedFromTab = (tab) => {
        switch (tab) {
            case 'Độc Hiếm':
                return 'Rare'; // Ensure this matches the breed in your database
            case 'Chó Bảo Vệ':
                return 'Guard Dog'; // Ensure this matches the breed in your database
            case 'Chó Mặt Xệ':
                return 'Droopy Face Dog'; // Ensure this matches the breed in your database
            case 'Chó Ngao':
                return 'Mastiff'; // Ensure this matches the breed in your database
            case 'Chó Bull':
                return 'Bull Dog'; // Ensure this matches the breed in your database
            case 'Chó Săn':
                return 'Hunting Dog'; // Ensure this matches the breed in your database
            case 'Chó Kéo Xe':
                return 'Sled Dog'; // Ensure this matches the breed in your database
            case 'Chó Xoáy':
                return 'Spinning Dog'; // Ensure this matches the breed in your database
            default:
