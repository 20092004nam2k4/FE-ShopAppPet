                        ...
                        <header className="align-c mb-1 image-intro__header">
                            ...
                            <div className="dark wysiwyg image-intro__description">
                                <p style={{ textAlign: "center" }}>
                                    Là trại nhân giống chó cảnh hàng đầu Việt Nam – Sau hơn 10 năm hoạt
                                    động AZPET đã cung cấp ra thị trường trên 25,000 bé thú cưng. Quy mô
                                    trại chính 7,000 m2, đồng thời hợp tác với hơn 100 hộ nhân giống trên
                                    toàn quốc…
                                </p>
                            </div>
                        </header>
