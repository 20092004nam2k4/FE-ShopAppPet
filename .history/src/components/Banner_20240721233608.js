       ...
       <div className="col-md-4 d-flex flex-column">
          <div className="banner-icons flex-fill">
            <table className="table">
              <tbody>
                <tr>
                  <td className="banner-icon-item">
                    <button className="banner-button" onClick={() => window.location.href='https://azpet.com.vn/cho-canh/'}>
                ...
                <tr>
                  <td className="banner-icon-item">
                    <button className="banner-button" onClick={() => window.location.href='https://azpet.com.vn/meo-canh/'}>
                      <span className="icon-pet">
                ...
                <tr>
                  <td className="banner-icon-item">
                    <button className="banner-button" onClick={() => window.location.href='https://hoptac.azpet.com.vn/'}>
                      <span className="icon-pet">
                ...
                <tr>
                  <td className="banner-icon-item">
                    <button className="banner-button" onClick={() => window.location.href='https://azpet.com.vn/'}>
                      <span className="icon-pet">
                ...
                <tr>
                  <td className="banner-icon-item">
                    <button className="banner-button" onClick={() => window.location.href='https://azpet.com.vn/spa/'}>
                      <span className="icon-pet">
