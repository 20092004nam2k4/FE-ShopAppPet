        ...
        <div className="col-md-8 d-flex flex-column">
          <div className="banner-images flex-fill">
            <div className="banner-large-image">
              <img src="https://azpet.com.vn/wp-content/uploads/2022/03/azpet-banner-desktop-1.jpg" alt="Large Banner" className="img-fluid" />
            </div>
            <div className="banner-small-images">
              <div className="banner-small-image">
                <img src="https://azpet.com.vn/wp-content/uploads/2022/03/banner-desktop-1.jpg" alt="Small Image 1" className="img-fluid" />
              </div>
              <div className="banner-small-image">
                <img src="https://azpet.com.vn/wp-content/uploads/2022/03/banner-desktop-2.jpg" alt="Small Image 2" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
