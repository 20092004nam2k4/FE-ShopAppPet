...
const ProductList = () => {
    ...
    const getBreedFromTab = (tab) => {
        // Map tab to breed for dogs and cats
        switch (tab) {
            case 'Độc Hiếm':
                return 'Rare';
            case 'Chó Bảo Vệ':
                        ...
                        <div className="tabs-wrapper">
                            <div className="tabs">
                                ...
                                <div className="arrow-btns">
                                    <button onClick={handlePrevDogs} className="arrow-btn" disabled={startIndex === 0}>
                                        &lt;
                                    </button>
                                    <button onClick={handleNextDogs} className="arrow-btn" disabled={startIndex + 5 >= TabDogs.length}>
                                        &gt;
                                    </button>
                                </div>
                            </div>
