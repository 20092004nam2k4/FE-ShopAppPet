            ...
            <div className="div-tong">
                <div className="sidebar">
                    <div className="sidebar__top-image">
                        <img src="https://example.com/sample-image.jpg" alt="Top Image" />
                    </div>
                    <h2 className="f aic parent-cat__title">
                        <span
                            ...
                            style={{
                                backgroundImage:
                                    'url("https://azpet.com.vn/wp-content/uploads/2021/07/azpet-banner-cho-canh-desktop.jpg")'
                            }}
                        />
                        <span className=" parent-cat__title-text">Giống Chó Cảnh</span>
                    </h2>
                    <div className="sidebar__bottom-image">
                        <img src="https://azpet.com.vn/wp-content/uploads/2021/07/azpet-banner-cho-canh-desktop.jpg" />
                    </div>
                </div>
