              ...
              <div className="header__right">
                ...
                <div className="header__search">
                  <button className="header__search-button js-header-search-button">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
                      <path d="M26.9,46.8a20.5,20.5,0,1,1,20.5-20.5A20.5,20.5,0,0,1,26.9,46.8Zm0-37a16.5,16.5,0,1,0,16.5,16.5A16.5,16.5,0,0,0,26.9,9.8Zm.4,23.4a1.2,1.2,0,0,0-1.2,1.2v.4a1.2,1.2,0,0,0,1.2,1.2h8.2a1.2,1.2,0,0,0,1.2-1.2v-.4a1.2,1.2,0,0,0-1.2-1.2Zm9.3,3.4a1.2,1.2,0,0,0-1.2,1.2v.4a1.2,1.2,0,0,0,1.2,1.2h8.2a1.2,1.2,0,0,0,1.2-1.2v-.4a1.2,1.2,0,0,0-1.2-1.2Zm-17,4.8a1.2,1.2,0,0,0-1.2,1.2v.4a1.2,1.2,0,0,0,1.2,1.2h8.2a1.2,1.2,0,0,0,1.2-1.2v-.4a1.2,1.2,0,0,0-1.2-1.2Zm0-7.3a1.2,1.2,0,0,0-1.2,1.2v.4a1.2,1.2,0,0/></>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
