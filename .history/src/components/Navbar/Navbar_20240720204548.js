...
const Navbar = () => {
    return (
        <header
  id="masthead"
  className="header header--layout-theme header--has-bg bg-primary header--dark-contract"
  data-child-block="header"
  data-sticky-header=""
>
              ...
              <div className="f fw header__logo-menu js-header-logo">
                ...
                <div className="header__vertical js-header-vertical">
                  <button className="f header__vertical-header js-header-vertical-button">
                    ...
                    <span className="header__vertical-title">
                      Danh mục sản phẩm
                    </span>
                  </button>
                  <div className="header__vertical-list js-header-vertical-content is-not-loaded">
                    <noscript>
                      ...
                      menu-item-object-product_cat menu-item--icon
                      menu-item--icon-image menu-item-687"&gt;&lt;a
                      href="https://azpet.com.vn/cho-canh/"&gt;&lt;span
                      class="menu-item__icon"&gt;&lt;img
                      class="menu-item__image"
                      src="https://azpet.com.vn/wp-content/uploads/2021/06/cho-canh-1.png"
                      alt=""&gt;&lt;/span&gt;&lt;span
                      class="menu-item__title"&gt;Giống Chó
                      Cảnh&lt;/span&gt;&lt;/a&gt;&lt;/li&gt; &lt;li
                      id="menu-item-18" class="menu-item menu-item-type-taxonomy
                      menu-item-object-product_cat menu-item--icon
                      menu-item--icon-image menu-item-18"&gt;&lt;a
                      href="https://azpet.com.vn/meo-canh/"&gt;&lt;span
                      class="menu-item__icon"&gt;&lt;img
                      class="menu-item__image"
                      src="https://azpet.com.vn/wp-content/uploads/2021/06/meo-canh-1.png"
                      alt=""&gt;&lt;/span&gt;&lt;span
                      class="menu-item__title"&gt;Giống Mèo
                      Cảnh&lt;/span&gt;&lt;/a&gt;&lt;/li&gt; &lt;li
                      id="menu-item-9131" class="menu-item
                      menu-item-type-post_type menu-item-object-page
                      menu-item-home current-menu-item page_item page-item-21
                      current_page_item menu-item--icon menu-item--icon-image
                      menu-item-9131"&gt;&lt;a href="https://azpet.com.vn/"
                      aria-current="page"&gt;&lt;span
                      class="menu-item__icon"&gt;&lt;img
                      class="menu-item__image"
                      src="https://azpet.com.vn/wp-content/uploads/2021/07/phu-kien-cho-meo-1.png"
                      alt=""&gt;&lt;/span&gt;&lt;span
                      class="menu-item__title"&gt;Phụ Kiện Chó
                      Mèo&lt;/span&gt;&lt;/a&gt;&lt;/li&gt; &lt;li
                      id="menu-item-8751" class="menu-item
                      menu-item-type-post_type menu-item-object-page
                      menu-item--icon menu-item--icon-image
                      menu-item-8751"&gt;&lt;a
                      ...
                      alt=""&gt;&lt;/span&gt;&lt;span
                      class="menu-item__title"&gt;Spa &amp;#038;
                      Grooming&lt;/span&gt;&lt;/a&gt;&lt;/li&gt; &lt;li
                      id="menu-item-14312" class="menu-item
                      ...
                      alt=""&gt;&lt;/span&gt;&lt;span
                      class="menu-item__title"&gt;Hợp tác nhân
                      giống&lt;/span&gt;&lt;/a&gt;&lt;/li&gt; &lt;/ul&gt;{" "}
                    </noscript>
                  </div>
                </div>
