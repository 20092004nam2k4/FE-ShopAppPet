...
const Navbar = () => {
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-red">
      ...
      <button class="f header__vertical-header js-header-vertical-button" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
