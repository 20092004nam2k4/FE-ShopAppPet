        ...
        <div className="nav">
            <div className="navbar navbar-expand-lg navbar-red">
                ...
                <div class="dgwt-wcas-sf-wrapp">
                    ...
                    <input id="dgwt-wcas-search-input-1" type="search" class="dgwt-wcas-search-input" name="s" value="" placeholder="Tìm thú cưng của bạn" autocomplete="off"></input>
                    ...
                    <input type="hidden" name="dgwt_wcas" value="1"></input>
