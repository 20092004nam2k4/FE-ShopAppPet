        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="col text-center">
              ...
              <ul className="f fw widget--icon-url-items mb-1">
                <li className="widget--icon-url-item">
                  <a href="https://www.youtube.com/channel/UC_xsdcYZ6nAu66WJjHsQqVA" className="footer-icon">
                ...
                <li className="widget--icon-url-item">
                  <a href="https://www.facebook.com/azpet.com.vn" className="footer-icon">
                    <span className="icon_svg">
                      {/* SVG for Facebook */}
                    </span>
                  </a>
                ...
                <li className="widget--icon-url-item">
                  <a href="https://zalo.me/1468374330755950828" className="footer-icon">
                    <span className="icon_svg">
                      {/* SVG for Zalo */}
                    </span>
                  </a>
