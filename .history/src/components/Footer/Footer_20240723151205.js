...
function Footer() {
  return (
    <div >
      <footer className="bg-white text-black pt-4 pb-4">
        <div className="container">
          <div className="row">
            <div className="grid__col footer__col footer__col--widget">
  <div id="text-3" className="widget widget--footer widget_text">
    <p className="widget__title">LIÊN HỆ AZPET</p>{" "}
    <div className="textwidget">
      ...
      <div className="information-item">
        <p>
          ...
          <a href="tel:0888083388">Hotline: 0888 08 3388</a>
        </p>
      </div>
      <div className="information-item">
        <p>
          ...
          <a href="https://azpet.com.vn/">Website: https://azpet.com.vn</a>
        </p>
      </div>
      <div className="information-item">
        <p>
          ...
          <a href="mailto:contact@azpet.com.vn">Email: contact@azpet.com.vn </a>
        </p>
      </div>
    </div>
  </div>
  ...
  <div
    id="azpet_icon_url-4"
    className="widget widget--footer widget_azpet_icon_url"
  >
    <ul className="f fw widget--icon-url-items azpet-bct-icon mt-0">
      <li className="widget--icon-url-item">
        <a href="#">
          <img src="https://azpet.com.vn/wp-content/uploads/2022/03/bo-cong-thuong-2.png" />
        </a>
      </li>
      <li className="widget--icon-url-item">
        <a href="#">
          <img src="https://azpet.com.vn/wp-content/uploads/2022/03/bct.png" />
        </a>
      </li>
    </ul>
  </div>
  {/* Close widget */}
              ...
              <div className="col text-center">
                ...
                <div className="icon-youtube">
                  <ul className="f fw widget--icon-url-items mb-1 ">
                    ...
                    <li className="widget--icon-url-item">
                      <a href="https://www.facebook.com/azpet.com.vn">
                        <span className="icon_svg">
                          <svg
                            width={32}
                            height={33}
                    ...
                    <li className="widget--icon-url-item">
                      <a href="https://zalo.me/1468374330755950828">
                        <span className="icon_svg">
                          <svg
                            width={32}
                            height={33}
                ...
                <div className="icon-2">
                  <ul className="f fw widget--icon-url-items ">
                    <li className="widget--icon-url-item">
                      <a href="#">
                        <span className="icon_svg">
                          <svg
                          ...
                          >
                            <path
                              ...
                              fill="#052E5C"
                            />
                            <circle cx="20.7059" cy="19.843" r="4.70588" fill="#0B74E5" />
                            <path
                        ...
                        <span className="icon_svg">
                          ...
                          >
                            <mask
                              ...
                              height={20}
                            >
                              <rect y={6} width={32} height={20} rx="1.81818" fill="white" />
                            </mask>
      ...
      <div className="footer__bottom">
        <div className="container footer__container">
          <div className="grid footer__bottom-grid">
            <div className="grid__col footer__bottom-col footer__bottom-col--left">
              <div className="footer__copyright-text">Copyright © 2021 by AZPET.</div>
            </div>
          </div>
        </div>
      </div>
