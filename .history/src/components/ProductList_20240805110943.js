...
import './CSS/ProductList.css'; // Import your custom CSS
...
const ProductList = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('/api/pets'); // Adjust the API endpoint if necessary
                setProducts(response.data.content); // Assuming the data is in the 'content' field
            } catch (error) {
